...
const WIDGETS =
  'TokensCatalog|IconGallery|ButtonPlayground|InputPlayground|CardPlayground|AlertPlayground|GlassPlayground|GooPlayground|ChartPlayground|DashboardExample|Markup'
