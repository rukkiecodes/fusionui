...
[Vuesax](https://vuesax.com), powered by Feather icons.
...
- **Feather icons** — 287 tree-shakeable icons ship by default.
- **Batteries included** — buttons, cards, inputs, selection controls, overlays, and more.
