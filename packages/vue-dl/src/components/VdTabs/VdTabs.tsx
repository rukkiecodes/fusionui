...
export const VdTabs = genericComponent()({
  name: 'VdTabs',
    ...
    useRender(() =>
      h(
        'div',
        {
          class: [
            'vd-tabs',
            `vd-tabs--align-${props.align}`,
            { 'vd-tabs--grow': props.grow },
            props.class,
          ],
          style: [{ '--vd-tabs-color': `var(--vd-theme-${props.color})` }, props.style],
          role: 'tablist',
        },
        [
          slots.default?.(),
          h('div', {
            class: 'vd-tabs__indicator',
