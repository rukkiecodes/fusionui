import type { ColorVariant, HeadingLevel, TextTheme } from './types'
import { DEFAULT_THEME } from './const'
const isColorVariant = (color: string): color is ColorVariant => {
  return color in DEFAULT_THEME.colors
}

const resolveColor = <T extends string | ColorVariant | undefined, Theme extends TextTheme>(
  color: T,
  theme: Theme
): string => {
