...
export const VdCheckbox = genericComponent()({
  name: 'VdCheckbox',
    ...
    useRender(() =>
      h(
        'label',
        {
          class: [
            ...
            'vd-selection-control',
            {
              ...
              'vd-selection-control--indeterminate': props.indeterminate,
              'vd-selection-control--disabled': props.disabled,
            },
            props.class,
          ],
        ...
        [
          ...
          h('span', { class: 'vd-selection-control__box vd-checkbox__box' }, [
            h('svg', { viewBox: '0 0 24 24', class: 'vd-checkbox__mark' }, [
              props.indeterminate
                ? h('path', { d: 'M6 12h12' })
