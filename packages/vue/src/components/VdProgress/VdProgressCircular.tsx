...
export const VdProgressCircular = genericComponent()({
  name: 'VdProgressCircular',
  ...
  setup(props: any) {
    ...
    useRender(() => {
      ...
      return h(
        ...
        {
          class: [
            'vd-progress-circular',
            { 'vd-progress-circular--indeterminate': props.indeterminate },
            ...colorClasses.value,
            props.class,
          ],
        ...
        [
          h('svg', { viewBox: '0 0 44 44', xmlns: 'http://www.w3.org/2000/svg' }, [
            h('circle', {
              class: 'vd-progress-circular__underlay',
              cx: 22,
              cy: 22,
              r: RADIUS,
              fill: 'transparent',
            ...
            h('circle', {
              class: 'vd-progress-circular__overlay',
              cx: 22,
              cy: 22,
              r: RADIUS,
              fill: 'transparent',
